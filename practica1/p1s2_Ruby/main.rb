...
# [CASTELLANO]
# Ejercicios - Practica 1 Sesión 2 (Ruby)
...
#
# [ENGLISH]
# Exercises - Practice 1 Session 2 (Ruby)
...
module P1S1
  ...
  anor_londo = Parcela.new("Anor Londo", 10, 20, 500)
  ...
  puts "Precio alquiler #{anor_londo.precio_alquiler_completo}"
end
